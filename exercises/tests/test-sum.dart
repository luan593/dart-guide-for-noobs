...
void main() {
  group('Sum of Two', () {
    ...
    test('twoSum([1, 3, 7, 9, 2], 25) ➞ null', () {
      expect(twoSum(array: [1, 3, 7, 9, 2], target: 25), null);
    });

    test('twoSum([]) ➞ 99', () {
      expect(twoSum(array: [], target: 99), null);
    });
    ...
    test('twoSum([1, 6], 7) ➞ [0, 1]', () {
      expect(twoSum(array: [1, 6], target: 7), [0, 1]);
    });

    test('twoSum([1, 5, 10, 6, 0]) ➞ [1, 4]', () {
      expect(twoSum(array: [1, 5, 10, 6, 0], target: 5), [1, 4]);
    });
